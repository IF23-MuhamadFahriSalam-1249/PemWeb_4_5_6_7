    ...
    <header class="header">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            <img src="Gambar/Ticketing.jpg" alt="Gambar Ticketing" class="img-fluid" />
          </div>
        </div>
      </div>
    </header>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card text-center">
              <img src="Gambar/Ticketing_Bus.jpg" class="card-img-top" alt="Tiket Bus" />
              <div class="card-body">
          ...
          <div class="col-md-4">
            <div class="card text-center">
              <img src="Gambar/Ticketing_Kereta2.jpg" class="card-img-top" alt="Tiket Kereta" />
              <div class="card-body">
          ...
          <div class="col-md-4">
            <div class="card text-center">
              <img src="Gambar/Ticketing_Pesawat2.jpg" class="card-img-top" alt="Tiket Pesawat" />
              <div class="card-body">
